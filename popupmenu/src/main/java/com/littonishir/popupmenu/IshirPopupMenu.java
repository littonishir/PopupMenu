...
public class IshirPopupMenu {
    ...
    private static final int DEFAULT_ANIM_STYLE = R.style.ANIM_STYLE;
    private int animationStyle;

    private float alpha = 0.75f;

    public IshirPopupMenu(Activity context) {
    ...
    private void init() {
        ...
        mAdapter = new Adapter(mContext, this, menuItemList, showIcon);
    }
    ...
    public IshirPopupMenu setHeight(int height){
    ...
    public IshirPopupMenu setWidth(int width){
    ...
    public IshirPopupMenu setItemDecoration(){
        mRecyclerView.addItemDecoration(new IshirDividerItem(mContext, DividerItemDecoration.VERTICAL));
        return this;
    }

    public IshirPopupMenu setItemDecoration(RecyclerView.ItemDecoration divider){
     ...
     * @return
     */
    public IshirPopupMenu showIcon(boolean show){
        this.showIcon = show;
        return this;
    }
     ...
     * @return
     */
    public IshirPopupMenu addMenuItem(MenuItem item){
     ...
     * @return
     */
    public IshirPopupMenu addMenuList(List<MenuItem> list){
     ...
     * @return
     */
    public IshirPopupMenu darkenBackground(boolean b){
     ...
     * @return
     */
    public IshirPopupMenu needAnimationStyle(boolean need){
     ...
     * @return
     */
    public IshirPopupMenu setAnimationStyle(int style){
        this.animationStyle = style;
        return this;
    }

    public IshirPopupMenu setOnMenuItemClickListener(OnMenuItemClickListener listener){
        mAdapter.setOnMenuItemClickListener(listener);
        return this;
    }

    public IshirPopupMenu showAsDropDown(View anchor){
        showAsDropDown(anchor, 0, 0);
        return this;
    }

    public IshirPopupMenu showAsDropDown(View anchor, int xoff, int yoff){
